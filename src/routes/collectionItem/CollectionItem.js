...
class CollectionItem extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            this.res = await fetch(`https://api.collection.cooperhewitt.org/rest/?method=cooperhewitt.objects.getInfo&access_token=0db51ba7deb780d01da809a707e194cf&object_id=${match.params.id}`);
